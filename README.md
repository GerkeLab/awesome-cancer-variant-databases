...
- [EpiTAD](https://apps.gerkelab.com/epiTAD/) - Compare genomic structures (e.g. topologically associating domains) and annotations across multiple databases and platforms in an interactive platform. [web app]
